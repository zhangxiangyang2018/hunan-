  ...
  <div class="file">
      ...
      <div class="content">
        ...
        -webkit-box-orient: vertical;"
            ...
            <ul
              ...
              @mouseleave="hideMenu()"
            >
              <li v-if="item.type==0&&userType!='ADMIN'" @click="subscribe(item)">订阅</li>
    ...
    <el-dialog title="新增文件夹" :visible.sync="isAdd" width="40%">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addSure(item)">确 定</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    fileUpload(id, ev) {
      ...
      form.append('id', id)
      form.append('uploader', this.admin)
      let config = {
        headers: {
    ...
    init() {
      ...
      this.$httpGet('public/fileTree').then(function(res) {
        if (res.data.code == 200) {
          ...
          // 判断当前点击的父对象是否为空为空的话则为第一次进来 否则保留进来时候的状态
